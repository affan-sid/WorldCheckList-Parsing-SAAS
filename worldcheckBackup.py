    ...
    try:
        ...
        Watchlistdata_to_insert = [
            (
                ...
                item.Status, item.YearOfBirth, item.WLCategory
            )
...
def populate_world_check(dir_list,ListID,LogID,path,TenantValue,ArchPath,ErrorPath,DB,VersionMSSQL):    #iss mein hogi changes
    count = 0
    filecount = 0
    # finalList = []
    # #lstWatchlistNew()
